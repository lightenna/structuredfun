 ...
 * @nodep Gtk
 */
if ('C:\core\working\structuredfun-pc\structured\vendor\php\pear' != '@'.'include_path'.'@') {
    ini_set('include_path', 'C:\core\working\structuredfun-pc\structured\vendor\php\pear');
    $raw = false;
} else {
