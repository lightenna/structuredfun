...
FOR %%x IN ("C:\core\working\structuredfun-pc\structured\vendor\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\core\working\structuredfun-pc\structured\vendor\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\core\working\structuredfun-pc\structured\vendor\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\core\working\structuredfun-pc\structured\vendor\php\php.exe"
GOTO :INSTALLED
